    ...
    <div className="min-h-screen">
      ...
      <section className="bg-ink-950 py-20 sm:py-28">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20">
          <AnimatedSection>
            <span className="text-[11px] font-semibold tracking-widest uppercase text-brand-400 mb-4 block">Tentang Kami</span>
      ...
      <section id="profil" className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20 py-20 sm:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <AnimatedSection>
            <span className="text-[11px] font-semibold tracking-widest uppercase text-brand-500 mb-4 block">Profil Perusahaan</span>
            ...
            <p className="mt-4 text-ink-400 text-[15px] leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className={i === 3 ? 'col-span-2 text-center' : ''}>
                    <div className={`font-display font-bold ${i === 3 ? 'text-4xl' : 'text-2xl'} text-ink-950`}>{h.value}</div>
      ...
      {/* Visi & Misi */}
      <section id="visi-misi" className="bg-gray-50 py-20 sm:py-28">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-8">
            <AnimatedSection>
              <div className="bg-white rounded-[20px] border border-gray-100 p-8 sm:p-10 h-full">
                <div className="w-12 h-12 bg-brand-50 rounded-xl flex items-center justify-center mb-6">
                  <Eye size={22} className="text-brand-600" />
                </div>
                <h3 className="font-display text-xl font-bold text-ink-950 mb-4">Visi</h3>
            ...
            <AnimatedSection delay={0.1}>
              <div className="bg-white rounded-[20px] border border-gray-100 p-8 sm:p-10 h-full">
                ...
                <h3 className="font-display text-xl font-bold text-ink-950 mb-4">Misi</h3>
                <ul className="space-y-3 text-ink-400 text-[15px] leading-relaxed">
                  <li className="flex gap-3"><span className="text-brand-500 mt-1">—</span>Menyediakan armada kendaraan berkualitas tinggi yang terawat dengan standar terbaik.</li>
                  <li className="flex gap-3"><span className="text-brand-500 mt-1">—</span>Memberikan layanan transportasi yang aman, nyaman, dan tepat waktu.</li>
                  <li className="flex gap-3"><span className="text-brand-500 mt-1">—</span>Terus berinovasi dalam teknologi dan layanan untuk memenuhi kebutuhan pelanggan.</li>
                  <li className="flex gap-3"><span className="text-brand-500 mt-1">—</span>Menjadi mitra transportasi yang handal bagi perusahaan dan instansi pemerintah.</li>
                </ul>
              </div>
            </AnimatedSection>
          </div>
      ...
      <section id="nilai" className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20 py-20 sm:py-28">
        <AnimatedSection className="max-w-xl mb-14">
          <span className="text-[11px] font-semibold tracking-widest uppercase text-brand-500 mb-4 block">Nilai Perusahaan</span>
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-ink-950 tracking-tight">Prinsip Yang Kami Pegang Teguh</h2>
        </AnimatedSection>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {values.map((v, i) => (
            <AnimatedSection key={v.title} delay={i * 0.06}>
              <div className="flex gap-4 p-6 rounded-[20px] border border-gray-100 bg-white hover:shadow-lg hover:shadow-black/5 transition-all duration-200 h-full">
                <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center shrink-0">
                  <v.icon size={18} className="text-ink-950" strokeWidth={1.5} />
                </div>
                <div>
                  <h3 className="font-semibold text-ink-950 text-[15px]">{v.title}</h3>
                  <p className="mt-1 text-ink-400 text-sm leading-relaxed">{v.desc}</p>
                </div>
              </div>
            </AnimatedSection>
          ))}
      ...
      {/* Sejarah */}
      <section id="sejarah" className="bg-gray-50 py-20 sm:py-28">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20">
          <AnimatedSection className="max-w-xl mb-14">
            <span className="text-[11px] font-semibold tracking-widest uppercase text-brand-500 mb-4 block">Sejarah</span>
            <h2 className="font-display text-2xl sm:text-3xl font-bold text-ink-950 tracking-tight">Perjalanan Kami</h2>
          </AnimatedSection>
      ...
      <section id="tim" className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20 py-20 sm:py-28">
        <AnimatedSection className="max-w-xl mb-14">
          <span className="text-[11px] font-semibold tracking-widest uppercase text-brand-500 mb-4 block">Tim Leadership</span>
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-ink-950 tracking-tight">Pimpinan Perusahaan</h2>
        </AnimatedSection>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {leadership.map((l, i) => (
            <AnimatedSection key={l.name} delay={i * 0.08}>
              <div className="bg-white rounded-[20px] border border-gray-100 p-7 text-center hover:shadow-lg hover:shadow-black/5 transition-all duration-200">
                <div className="w-20 h-20 bg-gray-100 rounded-full mx-auto mb-4 flex items-center justify-center">
                  <Users size={28} className="text-gray-300" />
                </div>
                <h3 className="font-display font-semibold text-ink-950 text-[15px]">{l.name}</h3>
                <p className="text-[11px] font-medium text-brand-500 mt-0.5">{l.role}</p>
                <p className="text-ink-400 text-sm mt-3 leading-relaxed">{l.desc}</p>
              </div>
            </AnimatedSection>
          ))}
        </div>
      ...
      <section className="bg-ink-950 py-20 sm:py-28">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20 text-center">
          <AnimatedSection>
            ...
            <p className="mt-3 text-ink-400 text-[15px] max-w-md mx-auto">Hubungi kami untuk konsultasi kebutuhan transportasi perusahaan Anda.</p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Link to="/kontak" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-ink-950 text-sm font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-200">
