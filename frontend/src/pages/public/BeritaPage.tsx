      ...
      <section className="bg-ink-950 py-20 sm:py-28">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-20">
          <AnimatedSection>
            ...
            <p className="mt-5 text-ink-400 text-[15px] leading-relaxed max-w-xl">Informasi terbaru seputar perkembangan dan aktivitas PT PILAR.</p>
          </AnimatedSection>
        </div>
      </section>
              ...
              <article className="group bg-white rounded-[20px] border border-gray-100 overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-black/5">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-0.5 bg-brand-50 text-[10px] font-semibold text-brand-600 rounded">{n.tag}</span>
                    <span className="text-[11px] text-ink-400">{n.date}</span>
                  </div>
                  <h3 className="font-display font-semibold text-[15px] text-ink-950 group-hover:text-brand-600 transition-colors">{n.title}</h3>
