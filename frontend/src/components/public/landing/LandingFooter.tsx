        ...
        <div className="py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-2 mt-5">
              ...
              <a href={`https://wa.me/${ADMIN_WA}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-ink-900 rounded-xl flex items-center justify-center hover:bg-avail-500/20 transition-colors" aria-label="WhatsApp">
