...
**UDIN RENCTCAR** — a garage/vehicle management system (Indonesian domain). Laravel 13.8 API backend + separate React 19 SPA frontend.
...
**Database**: `.env.example` defaults to MySQL (`DB_CONNECTION=mysql`, database `udin-renctcar`). Migrations in `database/migrations/`.
